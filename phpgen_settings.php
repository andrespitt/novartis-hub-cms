...
function GetGlobalConnectionOptions()
{
    return
        array(
          'server' => '162.243.185.221',
          'port' => '3306',
          'username' => 'novatestcom4',
          'password' => '15e497284badfe5fb',
          'database' => 'novatestcom',
...
{
    $result = array();
    $result[] = array('caption' => 'Events', 'short_caption' => 'Events', 'filename' => 'events01.php', 'name' => 'events01', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Next Events', 'short_caption' => 'Next Events', 'filename' => 'events0102.php', 'name' => 'events05', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Past Events', 'short_caption' => 'Past Events', 'filename' => 'events0101.php', 'name' => 'events04', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
